...
REM Pfad zum FME-Server
SET FME_SERVER_BASE_URL_PROD=[URL-TO_OPEN-DATA-REPO]
SET FME_SERVER_BASE_URL_TEST=[URL-TO_OPEN-DATA-REPO]
SET FME_SERVER_BASE_URL_DEV=[URL-TO_OPEN-DATA-REPO]
...
REM Festlegen, mit welcher Beschriftung STAG=NULL angezeigt werden soll ("--none--" bedeutet, keine Verwendung)
